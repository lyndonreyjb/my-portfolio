    ...
    <div className="flex justify-between items-center mx-auto px-4 pt-2 max-w-[1240px] text-brown">
      ...
      <div className="block md:hidden">
        ...
        <div 
          className={
            nav
              ? "rounded-l-lg cursor-pointer w-[30%] h-[33%] fixed right-0 top-0 border- bg-[#2a9d8f] ease-in-out duration-500 "
              : "rounded-l-lg top-0 w-[25%] h-[33%] ease-in-out duration-500 fixed right-[-100%]"
          }>
